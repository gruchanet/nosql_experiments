...
| Database					| Storage system:Compression	| Import time	|
|:-------------------------:|:-----------------------------:|:-------------:|
| MongoDB 2.6.5				| MMAP:none						| 54m56s		|
| MongoDB 2.8.0 rc0			| WiredTiger:none				| FAILED		|
| MongoDB 2.8.0 rc1-pre-	| WiredTiger:none				| 24m09s		|
| PostgreSQL 				| N/A							| 1h08m05s		|
